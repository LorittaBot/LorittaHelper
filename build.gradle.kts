...
dependencies {
    ...
    implementation("net.perfectdreams.galleryofdreams:common:1.0.3-20220326.222724-9")
    implementation("net.perfectdreams.galleryofdreams:client:1.0.3-20220326.222724-9")
