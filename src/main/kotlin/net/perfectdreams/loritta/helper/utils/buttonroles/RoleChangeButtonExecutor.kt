...
class RoleChangeButtonExecutor(val m: LorittaHelper) : ButtonClickWithDataExecutor {
    companion object : ButtonClickExecutorDeclaration(RoleChangeButtonExecutor::class, "role_change")
