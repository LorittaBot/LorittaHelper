...
class DJLorittaResponse : RegExResponse() {
    init {
        ...
        patterns.add("coloc[ar|a|o]|toc[ar|a]|adicion[a|o|ar]|ouvir|escuta|escuto|ouvo|ativa".toPattern(Pattern.CASE_INSENSITIVE))
        patterns.add("musicas|musica|música|músicas|msc".toPattern(Pattern.CASE_INSENSITIVE))
    }
